  ...
  return (
    <div>
      ...
      <div className="h-[100vh] w-[100vw] top-0 absolute -z-10 overflow-hidden bg-black">
        <img className='w-12/12 h-screen object-cover md:w-screen mx-auto fixed brightness-[.4] scale-125  xl:scale-105 ' 
        src={IMG_CDN + (movie?.backdrop_path || movie?.belongs_to_collection?.backdrop_path)}  
        alt="movieInfoBG" />
      </div>
      <Link to={"/browse"} >
